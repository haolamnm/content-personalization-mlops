...
- **Serialization is explicit**: POJO/Avro schemas registered and versioned; adding a field is backward-compatible by default, breaking changes need a topic/schema-version bump and a decision-log row.
