...
4. **Capture actuals**: `docker stats --no-stream` RSS per container → append one line to the running box's fact file §5 (`date · group · container · RSS`) — `.computers/MACBOOK.md` locally, `.computers/THINKBOOK.md` remotely. Estimates graduate here or die ([Principle 5](../../../AGENTS.md)).
